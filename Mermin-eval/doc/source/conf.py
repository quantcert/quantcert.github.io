...
project = u"A sage package to study entanglement in Grover's algorithm and in the QFT"
copyright = u'2019, Henri de Boutray'
package_name = 'Mermin-evaluation'
package_folder = "../../mermin_eval"
authors = u"Henri de Boutray"
