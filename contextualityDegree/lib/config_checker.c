...
int compute_category_list(bool to_print, int **category_list, int *category_count, quantum_assignment qa)
{
...
void filter_lines(bool to_print,quantum_assignment qa, bool *invalid_lines, int *number_of_invalid_lines, mode m, int *param, bool *line_filter, int **obs_specific_type_degree,int** category_count, int ***category_list)
{
