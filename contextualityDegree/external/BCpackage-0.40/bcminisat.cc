...
/* AM, 2/1/23: original main, disabled */
int
no_main(const int argc, const char** argv)
{
  BC* circuit = 0;
  int result = 0;
...
/* AM, 2/1/23: variant of the original main, link with ../quadrics.c */
extern "C" int is_sat(FILE *infile){
